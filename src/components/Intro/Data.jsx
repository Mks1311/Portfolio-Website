...
function Data() {
    ...
    return (
        ...
        className='mt-2 w-full flex flex-col justify-center items-center'>
            ...
            viewport={{ once: false }}
            className="h-fit flex items-center gap-3 lg:mb-4">
                <h1 className='mt-3 text-xl sm:text-[1.8rem] lg:text-[2.5rem]' >Manish Kumar Singh</h1>
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            className='mt-5 flex w-full text-[1.5rem] items-baseline  h-fit md:text-3xl font-thin justify-center sm:text-[2rem]'>
                I'm a <span 
                
                className='ml-2 text-[1.8rem] sm:text-[2.5rem] lg:text-[3rem]'>
                    <Typewriter
                        options={{
                            strings: ['FullStack Developer', 'MERN Developer', 'Coder'],
                            autoStart: true,
                            loop: true,
                        }}
                    />
